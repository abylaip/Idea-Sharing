...
ideasRouter.get("/", async (request, response) => {
  const idea = await Idea.find({ createdBy: request.user._id })
    .populate("createdBy")
    .populate("connectedUsers", "fullname")
    .sort([["updatedAt", "-1"]]);
  response.json(idea);
...
async function sendEmail(idea, user) {
  let transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: process.env.SHARE_EMAIL, //  generated ethereal user
      pass: process.env.SHARE_PASSWORD, // generated ethereal password
    },
  });

  let info = await transporter.sendMail({
    from: process.env.SHARE_EMAIL, // sender address
    to: idea.createdBy.email, // list of receivers
    subject: "Mind Connection - Interest in the Idea ✔", // Subject line
    ...
    * {
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 120%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 120%;"><span style="font-family: 'times new roman', times; font-size: 72px; line-height: 86.4px; color: #3e3e3e;">SOMEONE IS INTERESTED</span></p>
    <p style="font-size: 14px; line-height: 120%;"><span style="font-family: 'times new roman', times; font-size: 72px; line-height: 86.4px; color: #3e3e3e;">IN YOUR IDEA!</span></p>
      </div>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #3d3d3d; line-height: 150%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 150%;">Hello ${idea.createdBy.fullname}, my name is ${user.fullname} and I am a ${user.skills} from ${user.location}. I am interested in your idea about ${idea.title}, and I would like to help you implement this idea! Below will be my data please answer me on these contacts!</p>
      </div>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #3d3d3d; line-height: 120%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 120%;"><span style="font-family: 'times new roman', times; font-size: 30px; line-height: 36px;">${user.email}</span></p>
      </div>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #3d3d3d; line-height: 120%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 16px; line-height: 19.2px;">Fullname: ${user.fullname}</span></p>
      </div>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #3d3d3d; line-height: 120%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 16px; line-height: 19.2px;">Skills: ${user.skills}</span></p>
      </div>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #3d3d3d; line-height: 120%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 16px; line-height: 19.2px;">Location: ${user.location}</span></p>
      </div>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="color: #3d3d3d; line-height: 120%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 16px; line-height: 19.2px;">Position: ${user.position}</span></p>
      </div>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 120%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 24px; line-height: 28.8px; font-family: 'times new roman', times;">DON'T JUST DEVELOP - GET EXPERIENCE!</span></p>
      </div>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 150%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 150%;">Learn more about our service - just subscribe for miling lists!</p>
      </div>
    ...
    <div align="center">
      <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Montserrat',sans-serif;"><tr><td style="font-family:'Montserrat',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:56px; v-text-anchor:middle; width:196px;" arcsize="0%" stroke="f" fillcolor="#707070"><w:anchorlock/><center style="color:#FFF;font-family:'Montserrat',sans-serif;"><![endif]-->
        <a href="" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFF; background-color: #707070; border-radius: 0px; -webkit-border-radius: 0px; -moz-border-radius: 0px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
          <span style="display:block;padding:10px 30px;line-height:150%;"><span style="font-family: 'times new roman', times; font-size: 24px; line-height: 36px;">ANSWER NOW</span></span>
        </a>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 120%; text-align: left; word-wrap: break-word;">
        <div style="font-family: arial, helvetica, sans-serif;"><span style="font-size: 12px; color: #999999; line-height: 14.4px;">You received this email because you shared your idea in  IdeaSharing.com</span></div>
...
ideasRouter.get("/idea/:id/connect", async (request, response) => {
  const idea = await Idea.findById(request.params.id).populate("createdBy");
  if (!idea) {
  ...
  console.log("info: ", idea.createdBy);
